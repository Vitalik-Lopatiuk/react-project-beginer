...
const Button = ({
  ...
  return (
    <div className="btns-burger edit-for-burger">
      ...
      <button className="btn orange-btn" onClick={clearLastElement}>
        <BiArrowBack />
      </button>
      ...
      <button className="btn" value={8} onClick={heandleBtn}>
        8
      </button>
      <button className="btn" value={9} onClick={heandleBtn}>
        9
      </button>
      <button className="btn orange-btn" value={"*"} onClick={heandleBtn}>
        {" "}
      ...
      <button className="btn" value={2} onClick={heandleBtn}>
        2
      </button>
      <button className="btn" value={3} onClick={heandleBtn}>
        3
      </button>
      <button className="btn orange-btn" value={"-"} onClick={heandleBtn}>
        -
      ...
      <div className="last-btns-burger edit-for-burger">
        ...
        <button className="btn" value={"."} onClick={heandleBtn}>
          .
        </button>
        <button className="btn eval" onClick={evalExample}>
          =
        </button>
      </div>
    </div>
